...
@section('content')
<div class="max-w-3xl mx-auto selection:bg-[#234F35] selection:text-white px-3 sm:px-0 font-sans antialiased">
    <!-- Header Page & Navigation -->
    <div class="mb-8 flex items-center justify-between">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.siswa.index') }}" 
               class="w-11 h-11 bg-white hover:bg-slate-50 text-slate-600 hover:text-[#234F35] rounded-2xl flex items-center justify-center border border-slate-200/80 shadow-xs hover:shadow-md hover:border-emerald-200 transition-all duration-200 group cursor-pointer"
        ...
        <div class="hidden sm:inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200/80 px-3.5 py-1.5 rounded-full">
            <span class="w-2 h-2 rounded-full bg-[#89C74A] animate-pulse"></span>
            <span class="text-xs font-bold text-[#234F35] uppercase tracking-wider">Siswa Aktif</span>
        </div>
    </div>
        ...
        <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" class="p-6 sm:p-10 space-y-7">
            ...
            <div class="space-y-5">
                <div class="flex items-center gap-2 pb-2 border-b border-slate-100">
                    <i class="fas fa-id-badge text-[#234F35] text-sm"></i>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="name" value="{{ old('name', $siswa->name) }}" 
                            class="w-full pl-11 pr-4 py-3.5 bg-slate-50/50 focus:bg-white border @error('name') border-rose-400 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 @else border-slate-200/90 focus:border-[#234F35] focus:ring-4 focus:ring-emerald-900/10 @enderror rounded-2xl text-sm font-semibold text-slate-800 placeholder:text-slate-400 outline-none transition-all shadow-2xs" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="nomor_identitas" value="{{ old('nomor_identitas', $siswa->nomor_identitas) }}" 
                                class="w-full pl-11 pr-4 py-3.5 bg-slate-50/50 focus:bg-white border font-mono @error('nomor_identitas') border-rose-400 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 @else border-slate-200/90 focus:border-[#234F35] focus:ring-4 focus:ring-emerald-900/10 @enderror rounded-2xl text-sm font-bold text-slate-800 outline-none transition-all shadow-2xs" 
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-slate-400 group-focus-within:text-[#234F35] transition-colors z-10">
                                <i class="fas fa-graduation-cap text-sm"></i>
                            </span>
                            <select name="jurusan_id" class="w-full pl-11 pr-10 py-3.5 bg-slate-50/50 focus:bg-white border @error('jurusan_id') border-rose-400 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 @else border-slate-200/90 focus:border-[#234F35] focus:ring-4 focus:ring-emerald-900/10 @enderror rounded-2xl text-sm font-semibold text-slate-800 outline-none transition-all cursor-pointer appearance-none shadow-2xs" required>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="no_hp" value="{{ old('no_hp', $siswa->no_hp) }}" 
                            class="w-full pl-11 pr-4 py-3.5 bg-slate-50/50 focus:bg-white border @error('no_hp') border-rose-400 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 @else border-slate-200/90 focus:border-[#234F35] focus:ring-4 focus:ring-emerald-900/10 @enderror rounded-2xl text-sm font-semibold text-slate-800 outline-none transition-all shadow-2xs" 
